...
.login-form-btn {
  ...
  margin-top: 2rem;
  background: #1C4087;
  background: -webkit-linear-gradient(to left, #05718a, #1C4087);
  background: -o-linear-gradient(to left, #05718a, #1C4087);
  background: -moz-linear-gradient(to left, #05718a, #1C4087);
  background: linear-gradient(to left, #05718a, #1C4087);
}
